...
class AfipwsConnection(models.Model):
    ...
    def _get_ws(self, afip_ws):
        ...
        if afip_ws == 'wsfe':
            from py3afipws.wsfev1 import WSFEv1
            ws = WSFEv1()
        elif afip_ws == "wsfex":
            from py3afipws.wsfexv1 import WSFEXv1
            ws = WSFEXv1()
        elif afip_ws == "wsmtxca":
            from py3afipws.wsmtx import WSMTXCA
            ws = WSMTXCA()
        elif afip_ws == "wscdc":
            from py3afipws.wscdc import WSCDC
            ws = WSCDC()
        elif afip_ws == "wsbfe":
            from py3afipws.wsbfev1 import WSBFEv1
            ws = WSBFEv1()
        return ws
