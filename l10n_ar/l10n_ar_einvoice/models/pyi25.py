...
class PyI25:
    ...
    def GenerarImagen(self, codigo, archivo="barras.png",
        ...
        # c�digos ancho/angostos (wide/narrow) para los dígitos
        ...
        im = Image.new("1", (int(width), int(height)))
    ...
    def DigitoVerificadorModulo10(self, codigo):
        ...
        # la etapa 4 de un número múltiplo de 10. Este será el valor del dígito
