...
class AccountInvoice(models.Model):
    ...
    def create(self, vals):
        ...
        if not Partner.afip_responsability_type_id and \
           self.company_id.localization != 'argentina':
            raise ValidationError(_(
                "Si ya seleccionó el Cliente y no se selecciona "
                "automáticamente el Tipo de Documento, debe actualizar los "
                "datos del cliente en el módulo de Contactos y agregar el "
                "Tipo de Responsabilidad AFIP del cliente."
            ))
    ...
    def write(self, vals):
        ...
        if partner_id:
            ...
            if not Partner.afip_responsability_type_id:
                raise ValidationError(_(
                    "Si ya seleccionó el Cliente y no se selecciona "
                    "automáticamente el Tipo de Documento, debe "
                    "actualizar los datos del cliente en el módulo de "
                    "Contactos y agregar el Tipo de Responsabilidad "
                    "AFIP del cliente."
                ))
